...
class SyncController extends AbstractController
{
    ...
    #[Route('/countries/{code}', name: 'pays', methods: ['POST'])]
    #[OA\Post(path: '/api/sync/countries/{code}', summary: 'Manually trigger the sync of a country')]
    #[OA\Response(response: 202, description: 'Sync triggered')]
    #[OA\Response(response: 404, description: 'Country not found')]
    public function syncPays(string $code): JsonResponse
    {
