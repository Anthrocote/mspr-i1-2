...
export const faq: HelpArticle = {
  ...
  blocks: {
    fr: [
      ...
      { kind: 'qa', q: 'Que compte la durée affichée d\'un lot ?', a: 'C\'est le temps écoulé depuis la première mise en stock du lot, pas depuis son arrivée dans l\'entrepôt actuel. Un transfert entre entrepôts ne remet donc pas ce compteur à zéro. Au-delà de 365 jours, le lot est marqué périmé.' },
    ...
    en: [
      ...
      { kind: 'qa', q: 'What does a lot\'s displayed duration count?', a: 'It is the time since the lot first went into storage, not since it arrived at the current warehouse. A transfer between warehouses therefore does not reset the counter. Past 365 days, the lot is marked expired.' },
    ...
    es: [
      ...
      { kind: 'qa', q: '¿Qué cuenta la duración mostrada de un lote?', a: 'Es el tiempo transcurrido desde que el lote entró por primera vez en almacenamiento, no desde su llegada al almacén actual. Una transferencia entre almacenes no reinicia el contador. Pasados 365 días, el lote se marca como caducado.' },
