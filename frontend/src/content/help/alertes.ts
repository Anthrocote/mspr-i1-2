...
export const alertes: HelpArticle = {
  ...
  blocks: {
    fr: [
      { kind: 'heading', text: 'Trois familles d\'alertes' },
      { kind: 'paragraph', text: 'La page Alertes regroupe les situations à risque détectées automatiquement. Elles se répartissent en trois familles : les conditions de stockage hors plage, les capteurs hors ligne, et les lots trop anciens.' },
      ...
      { kind: 'heading', text: 'Capteur hors ligne' },
      { kind: 'paragraph', text: 'Quand le capteur d\'un entrepôt cesse d\'émettre — plus aucun relevé, ou une mesure en erreur — une alerte « capteur hors ligne » s\'ouvre et un email part au destinataire du pays. Elle se résout dès que le capteur émet de nouveau. Tant qu\'il est muet, les conditions réelles ne sont plus surveillées : vérifiez le capteur sur place.' },
      ...
      { kind: 'callout', tone: 'info', text: 'Le destinataire configuré pour le pays reçoit un email à l\'ouverture d\'une alerte de conditions ou de capteur, et un autre à sa résolution.' },
    ],
    en: [
      { kind: 'heading', text: 'Three families of alerts' },
      { kind: 'paragraph', text: 'The Alerts page gathers the risk situations detected automatically. They fall into three families: out-of-range storage conditions, offline sensors, and lots that are too old.' },
      ...
      { kind: 'heading', text: 'Sensor offline' },
      { kind: 'paragraph', text: 'When a warehouse\'s sensor stops reporting — no more readings, or a faulty measurement — a "sensor offline" alert opens and an email goes to the country recipient. It resolves as soon as the sensor reports again. While it stays silent, the actual conditions are no longer monitored: check the sensor on site.' },
      ...
      { kind: 'callout', tone: 'info', text: 'The recipient configured for the country receives an email when a condition or sensor alert opens and another when it resolves.' },
    ],
    es: [
      { kind: 'heading', text: 'Tres familias de alertas' },
      { kind: 'paragraph', text: 'La página de Alertas reúne las situaciones de riesgo detectadas automáticamente. Se dividen en tres familias: las condiciones de almacenamiento fuera de rango, los sensores desconectados y los lotes demasiado antiguos.' },
      ...
      { kind: 'heading', text: 'Sensor desconectado' },
      { kind: 'paragraph', text: 'Cuando el sensor de un almacén deja de emitir — sin más lecturas, o con una medición errónea — se abre una alerta «sensor desconectado» y se envía un correo al destinatario del país. Se resuelve en cuanto el sensor vuelve a emitir. Mientras permanece mudo, las condiciones reales dejan de vigilarse: compruebe el sensor in situ.' },
      ...
      { kind: 'callout', tone: 'info', text: 'El destinatario configurado para el país recibe un correo cuando se abre una alerta de condiciones o de sensor, y otro cuando se resuelve.' },
    ],
  },
};
