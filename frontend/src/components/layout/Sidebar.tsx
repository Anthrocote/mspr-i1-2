...
import { CONSOLIDATED, ALERTS } from '@/data/mock';
...
const MENU_ITEMS = [
  ...
  { id: 'lots', label: 'Gestion des Lots', href: '/lots', badge: String(CONSOLIDATED.totalLots), badgeColor: 'bg-espresso-700 text-espresso-200', icon: (
  ...
  { id: 'alertes', label: 'Alertes', href: '/alertes', badge: String(ALERTS.length), badgeColor: 'bg-[#9B1C1C] text-white', icon: (
