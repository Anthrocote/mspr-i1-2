...
const MENU_ITEMS = [
  ...
  { id: 'lots', label: 'Gestion des Lots', href: '/lots', badge: '248', badgeColor: 'bg-espresso-700 text-espresso-200', icon: (
  ...
  { id: 'alertes', label: 'Alertes', href: '/alertes', badge: '7', badgeColor: 'bg-[#9B1C1C] text-white', icon: (
