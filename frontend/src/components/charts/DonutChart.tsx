...
export default function DonutChart() {
  ...
  return (
    ...
    >
      <div className="font-display text-xl font-semibold text-espresso-900 mb-1.5">{t('lots_status')}</div>
      <div className="text-xs text-parchment-700 mb-[18px]">{t('global_distribution')}</div>
      <div className="flex items-center gap-[22px]">
        <svg width="128" height="128" viewBox="0 0 100 100">
          ...
          <text x="50" y="61" textAnchor="middle" style={{ fontFamily: 'var(--font-body)', fontSize: '7px', fill: '#A0714F' }}>{t('compliant')}</text>
        </svg>
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-[9px] text-[13px] text-neutral-700">
            ...
            {t('status_ok')} · <b className="text-espresso-900">174</b>
          </div>
          <div className="flex items-center gap-[9px] text-[13px] text-neutral-700">
            <span className="w-[11px] h-[11px] rounded-[3px] bg-[#B45309]" />
            {t('in_alert_chart')} · <b className="text-espresso-900">72</b>
          </div>
          <div className="flex items-center gap-[9px] text-[13px] text-neutral-700">
            <span className="w-[11px] h-[11px] rounded-[3px] bg-[#9B1C1C]" />
            {t('expired_chart')} · <b className="text-espresso-900">2</b>
          </div>
        </div>
      </div>
    </motion.div>
